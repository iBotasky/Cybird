...
import com.sirius.cybird.databinding.FragmentHome2Binding
import com.sirius.cybird.ui.base.BaseLazyFragment
import java.util.*

class MovieHotFragment : BaseLazyFragment() {
    lateinit var mMovieHotBinding: FragmentHome2Binding
    override fun setupViews() {
        super.setupViews()
        mMovieHotBinding = getBaseViewBinding()
        setupRecyclerView(mMovieHotBinding.recycler)
    }
    ...
    override fun loadData() {
        mMovieHotBinding.recycler.adapter = SimpleStringRecyclerViewAdapter(activity!!, getRandomSublist(sCheeseStrings, 30))
    }
